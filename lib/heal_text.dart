...
class HealText extends PositionComponent with HasGameReference<ShootingGame> {
  final int healAmount;
  double _elapsedTime = 0.0;
  static const double _duration = 0.8; // 表示時間（秒）

  HealText({required Vector2 position, required this.healAmount}) {
  ...
  void render(Canvas canvas) {
    ...
    final textPainter = TextPainter(
      text: TextSpan(text: '+$healAmount', style: textStyle),
